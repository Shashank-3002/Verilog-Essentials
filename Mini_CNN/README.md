...
A **hardware implementation of a mini Convolutional Neural Network (CNN) compute unit** in **Verilog**, designed for hardware accelerator use.  
...
![Output Log](./Simulation_Output.png)
